...
@Component({
  selector: 'app-appointmentslist-refferer',
  templateUrl: './appointmentslist-refferer.component.html',
  styleUrls: ['./appointmentslist-refferer.component.sass']
})
export class AppointmentslistReffererComponent   implements AfterViewInit  {
  displayedColumns = [
    'patient_name',
    'DoctorName',
    'slot_start',
